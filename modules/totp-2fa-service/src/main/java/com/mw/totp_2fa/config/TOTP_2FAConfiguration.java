...
public interface TOTP_2FAConfiguration {
	...
	@Meta.AD(deflt = "60", required = false, type = Type.Integer, name = "configuration.qrcodeUrlDurationMinutes.name", description = "configuration.qrcodeUrlDurationMinutes.desc")
